        ...
        for record in self:
            ...
            if record.rate:
                ...
                for each in loan_app_ids:
                    if record.operation == 'increase':
                        new_rate = each.rate + record.rate
                    if record.operation == 'decrease':
                        new_rate = each.rate - record.rate
                    ...
                    record.loan_adjustment_ids = final_list
...
class LoanAdjustmentLine(models.Model):
