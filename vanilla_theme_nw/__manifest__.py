...
{
    'name': 'Vanilla Backend Theme',
    'version': '15.0.1.0.0',
    'live_test_url': 'https://youtu.be/ZKSFVS4Iblo',
    'sequence': 1,
    'summary': """
    ...
    'assets': {
        'web.assets_qweb': [
            'vanilla_theme_nw/static/src/xml/sidebar.xml',
        ],
        'web.assets_backend': [
            'vanilla_theme_nw/static/src/scss/variable.scss',
            'vanilla_theme_nw/static/src/scss/global.scss',
            'vanilla_theme_nw/static/src/scss/menu.scss',
            'vanilla_theme_nw/static/src/scss/control_panel.scss',
            'vanilla_theme_nw/static/src/scss/searchpanel.scss',
            'vanilla_theme_nw/static/src/scss/list.scss',
            'vanilla_theme_nw/static/src/scss/form.scss',
            'vanilla_theme_nw/static/src/scss/pivot.scss',
            'vanilla_theme_nw/static/src/scss/activity.scss',
            'vanilla_theme_nw/static/src/js/sidebar.js',
        ],
    },
    'demo': [
