        ...
        for inv in self:
            ...
            if inv.state != 'draft':
                ...
                for tax in inv._get_tax_line_ids():
                    ...
                    #inv.invoiced_itbis = abs(inv.invoiced_itbis)
                ...
                for tax in inv._get_tax_line_ids():
                    ...
                    #inv.cost_itbis = abs(inv.cost_itbis)
